        ...
        <>
            ...
            <Modal destroyOnClose title="Cadastro de Pessoa" visible={isModalVisible} onOk={form.submit} onCancel={handleCancel} footer={[
                ...
                >
                    ...
                    <Form.Item label="CPF" name="cpf" validateTrigger="onBlur" rules={[{ required: true, len:11, message: 'Informe o CPF valido' }]}>
                        <Input placeholder="CPF da pessoa (sem mascara)" value={pessoa?.cpf}  onChange={(e) => setPessoa({ ...pessoa, cpf: e.target.value })} maxLength={11} />
                    </Form.Item>
                    <Form.Item label="Data De Nascimento" validateTrigger="onBlur" name="dataNascimento" rules={[{ required: true, message: 'Informe a Data de Nascimento' }]}>
                        <DatePicker
                    ...
                    <Form.Item label="Cidade" name="cidadeId" validateTrigger="onBlur" rules={[{ required: true, message: 'Informe a cidade de onde é a pessoa' }]}>
